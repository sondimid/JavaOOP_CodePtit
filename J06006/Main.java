...
class Invoice implements Comparable<Invoice>{
    ...
    public long getProfit(){
        return getCost() - item.getPurchasePrice() * quantity;
    }
    @Override
    public String toString() {
        return String.format("%s %s %s %s %d %d %d", id, customer.getName(), customer.getAddress(), item.getName(), quantity, getCost(), getProfit());
    }
